...
//useEffect hook for aos 
   useEffect(()=>{
    ...
    return(
        <div id="About"className=" bg-[#daffcf]  py-10 flex flex-col justify-evenly gap-8 items-center" data-aos="fade-up" > 
