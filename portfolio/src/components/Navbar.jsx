...
function Navbar(){
    ...
    return(
        ...
        <div className="bg-[#021526] z-10 text-white py-4 px-10 sticky top-0 shadow-lg flex justify-between items-center w-full">
            <div>
                <h1 className="text-xl font-bold">TechPortfolio</h1>
            </div>

           
     
            <ul className="justify-around gap-12 font-bold hidden md:flex">
                <li className="p-2"><Link to="Hero"  smooth={true} duration={500}>Home</Link></li>
                ...
                <li className="p-2"><Link to="ContactMe"  smooth={true} duration={500}>Contacts</Link></li>
            </ul>
        ...
        >
          <li className="list-none w-full text-center p-2"><Link to="Hero"  smooth={true} duration={500}>Home</Link></li>
          ...
          <li className="list-none w-full text-center p-2"><Link to="ContactMe"  smooth={true} duration={500}>Contacts</Link></li>
        </div>
